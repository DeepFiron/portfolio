...
function About() {
  return (
    <>
      ...
      <article className="my-2 lg:my-6 lg:mr-16 lg:ml-4 text-left lg:text-justify">
        <section className="p-2">
          <h2 className="text-2xl md:text-4xl font-bold pb-2 text-yellow-200">Intro</h2>
        ...
        <section className="p-2">
          <h2 className="text-2xl md:text-4xl font-bold pb-2 text-yellow-200">Skills</h2>
          <div className="pb-4 text-base md:text-xl indent-2">
            I'm capable of building interactive, modular, scalable &amp;
            maintainable applications. I've good frontend skills and working on
            backend as well.
          </div>
          <h3 className="text-xl md:text-2xl font-semibold p-1.5 text-yellow-200 ">
            Soft Skills
          </h3>
          <ul className="pb-4 ">
            <li className="text-base md:text-xl grid grid-cols-12 pb-4 gap-x-1 md:gap-x-4">
              <svg
                stroke="currentColor"
                fill="currentColor"
                stroke-width="0"
          ...
          <ul className="skills-list">
            ...
            <li className="text-base md:text-xl grid grid-cols-12 pb-4 gap-x-1 md:gap-x-4 hidden">
              <svg
                stroke="currentColor"
                fill="currentColor"
                stroke-width="0"
            ...
            <li className="text-base md:text-xl grid grid-cols-12 pb-4 gap-x-1 md:gap-x-4">
              ...
              <span className="justify-self-stretch col-span-11">
                ...
                strategy in the form of a short &amp; long-term product roadmap,
                prioritizing features based on level of importance.
              </span>
            </li>
          </ul>
          <h3 className="text-xl md:text-2xl font-semibold p-1.5 text-yellow-200 ">
